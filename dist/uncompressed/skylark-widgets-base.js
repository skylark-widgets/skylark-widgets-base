...
define('skylark-widgets-base/canvas-pane',[
  "./base",
  "./widget"
],function(
	base,
...
define('skylark-widgets-base/image-pane',[
  "./base",
  "./widget"
],function(
	base,
...
define('skylark-widgets-base/mixins/text-mixin',[
	"skylark-langx-numerics/vector2",
	"../widget"
],function(
	Vector2,
...
define('skylark-widgets-base/text-pane',[
  "./base",
  "./widget",
  "./mixins/text-mixin"
],function(
...
define('skylark-widgets-base/submit-form',[
	"./base",
	"./widget"
...
define('skylark-widgets-base/panels/dual-container',[
	"../base",
	"./panel",
],function( base, Panel){
	"use strict";
...
define('skylark-widgets-base/panels/dual-panel',[
	"../base",
	"./panel"
],function( base, Panel){
	"use strict";
...
define('skylark-widgets-base/panels/rows-panel',[
	"skylark-langx-numerics/vector2",
	"../base",
	"../text-pane",
	"./panel"
...
define('skylark-widgets-base/dnd/drag-buffer',[
],function(){	
	"use strict";
...
define('skylark-widgets-base/skins/skin-dark',[
	"./skin-manager"
],function(SkinManager){	
	"use strict";
